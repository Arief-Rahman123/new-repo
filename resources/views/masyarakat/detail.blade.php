                                                ...
                                                <form class="form form-horizontal">
                                                    <div class="form-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <textarea name="isi_pengaduan" class="form-control mb-2 @error('isi_pengaduan') @enderror" cols="30" rows="5" readonly>{{ $pengaduan->isi_pengaduan }}</textarea>
                                                            </div>
                                                            <div class="col-md-4">
                    ...
                    <div class="col-6 justify-content-center">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <img src="{{ asset('berkas/pengaduan/' . $pengaduan->file) }}" style="width:100%;border:1px solid rgb(223, 223, 223);">
                            </div>
                        </div>
                    </div>
                                                ...
                                                <form class="form form-horizontal">
                                                    <div class="form-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <textarea name="isi_pengaduan" class="form-control mb-2 @error('isi_pengaduan') @enderror" cols="30" rows="5" readonly>{{ $tanggapan->tanggapan }}</textarea>
                                                            </div>
                                                            <div class="col-12 d-flex justify-content-end">
                                                                <a href="{{ route('masyarakat/dashboard') }}" class="btn btn-primary me-1 mb-1">
                                                                    Back</a>
                                                            </div>
                                                        </div>
                                                    </div>
